            ...
            <div class="col-sm-10">
              <div class="input-group mb-3">
                <div class="input-group">
                  <input type="date" class="form-control" @if($exp->in_progress == 1) aria-disabled="true" @endif  id="exp_end_date_{{ $index }}" name="exp_end_date[]" value="{{ isset($exp->end_date) ? date('Y-m-d', strtotime($exp->end_date)) : '' }}">
                  <div class="input-group-text">
                    <input
                        ...
                        @if($exp->in_progress == 1) checked @endif
